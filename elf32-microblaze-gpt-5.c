...
{
  size_t i;
  const size_t raw_count = NUM_ELEM(microblaze_elf_howto_raw);
  const size_t table_count = NUM_ELEM(microblaze_elf_howto_table);

  for (i = raw_count; i > 0; i--)
    {
      size_t idx = i - 1;
      unsigned int type = microblaze_elf_howto_raw[idx].type;
      size_t type_index = (size_t) type;

      if (type_index >= table_count)
        {
          BFD_ASSERT(type_index < table_count);
          continue;
        }

      microblaze_elf_howto_table[type_index] = &microblaze_elf_howto_raw[idx];
    }
}

static int microblaze_map_reloc(bfd_reloc_code_real_type code, enum elf_microblaze_reloc_type *out)
{
  switch (code)
    {
    case BFD_RELOC_NONE:
      *out = R_MICROBLAZE_NONE;
      return 1;
    case BFD_RELOC_MICROBLAZE_32_NONE:
      *out = R_MICROBLAZE_32_NONE;
      return 1;
    case BFD_RELOC_MICROBLAZE_64_NONE:
      *out = R_MICROBLAZE_64_NONE;
      return 1;
    case BFD_RELOC_32:
    case BFD_RELOC_RVA:
      *out = R_MICROBLAZE_32;
    ...
    case BFD_RELOC_32_PCREL:
      *out = R_MICROBLAZE_32_PCREL;
      return 1;
    case BFD_RELOC_64_PCREL:
      *out = R_MICROBLAZE_64_PCREL;
      return 1;
    case BFD_RELOC_MICROBLAZE_32_LO_PCREL:
      *out = R_MICROBLAZE_32_PCREL_LO;
      return 1;
    case BFD_RELOC_64:
      *out = R_MICROBLAZE_64;
      return 1;
    case BFD_RELOC_MICROBLAZE_32_LO:
      *out = R_MICROBLAZE_32_LO;
      return 1;
    case BFD_RELOC_MICROBLAZE_32_ROSDA:
      *out = R_MICROBLAZE_SRO32;
      return 1;
    case BFD_RELOC_MICROBLAZE_32_RWSDA:
      *out = R_MICROBLAZE_SRW32;
      return 1;
    case BFD_RELOC_MICROBLAZE_32_SYM_OP_SYM:
      *out = R_MICROBLAZE_32_SYM_OP_SYM;
      return 1;
    case BFD_RELOC_VTABLE_INHERIT:
      *out = R_MICROBLAZE_GNU_VTINHERIT;
      return 1;
    case BFD_RELOC_VTABLE_ENTRY:
      *out = R_MICROBLAZE_GNU_VTENTRY;
      return 1;
    case BFD_RELOC_MICROBLAZE_64_GOTPC:
      *out = R_MICROBLAZE_GOTPC_64;
      return 1;
    case BFD_RELOC_MICROBLAZE_64_GOT:
      *out = R_MICROBLAZE_GOT_64;
      return 1;
    case BFD_RELOC_MICROBLAZE_64_TEXTPCREL:
      *out = R_MICROBLAZE_TEXTPCREL_64;
      return 1;
    case BFD_RELOC_MICROBLAZE_64_TEXTREL:
      *out = R_MICROBLAZE_TEXTREL_64;
      return 1;
    case BFD_RELOC_MICROBLAZE_64_PLT:
      *out = R_MICROBLAZE_PLT_64;
      return 1;
    case BFD_RELOC_MICROBLAZE_64_GOTOFF:
      *out = R_MICROBLAZE_GOTOFF_64;
      return 1;
    case BFD_RELOC_MICROBLAZE_32_GOTOFF:
      *out = R_MICROBLAZE_GOTOFF_32;
      return 1;
    case BFD_RELOC_MICROBLAZE_64_TLSGD:
      *out = R_MICROBLAZE_TLSGD;
      return 1;
    case BFD_RELOC_MICROBLAZE_64_TLSLD:
      *out = R_MICROBLAZE_TLSLD;
      return 1;
    case BFD_RELOC_MICROBLAZE_32_TLSDTPREL:
      *out = R_MICROBLAZE_TLSDTPREL32;
      return 1;
    case BFD_RELOC_MICROBLAZE_64_TLSDTPREL:
      *out = R_MICROBLAZE_TLSDTPREL64;
      return 1;
    case BFD_RELOC_MICROBLAZE_32_TLSDTPMOD:
      *out = R_MICROBLAZE_TLSDTPMOD32;
      return 1;
    case BFD_RELOC_MICROBLAZE_64_TLSGOTTPREL:
      *out = R_MICROBLAZE_TLSGOTTPREL32;
      return 1;
    case BFD_RELOC_MICROBLAZE_64_TLSTPREL:
      *out = R_MICROBLAZE_TLSTPREL32;
      return 1;
    case BFD_RELOC_MICROBLAZE_COPY:
      *out = R_MICROBLAZE_COPY;
      return 1;
    default:
      return 0;
    }
				  ...
				  bfd_reloc_code_real_type code)
{
  ...
  if (!microblaze_map_reloc(code, &microblaze_reloc))
...
static reloc_howto_type *
microblaze_elf_reloc_name_lookup (bfd *abfd ATTRIBUTE_UNUSED, const char *r_name)
{
  if (r_name == NULL)
    return NULL;

  unsigned int count = NUM_ELEM (microblaze_elf_howto_raw);
  reloc_howto_type *it = microblaze_elf_howto_raw;
  reloc_howto_type *end = it + count;
...
static bool
microblaze_elf_info_to_howto (bfd *abfd, arelent *cache_ptr, Elf_Internal_Rela *dst)
{
  unsigned int r_type;
  ...
  if (R_MICROBLAZE_32 < R_MICROBLAZE_max && !microblaze_elf_howto_table[R_MICROBLAZE_32])
    microblaze_elf_howto_init ();

  r_type = ELF32_R_TYPE (dst->r_info);
  if (r_type >= (unsigned int) R_MICROBLAZE_max)
    {
  ...
  if (microblaze_elf_howto_table[r_type] == NULL)
    {
      _bfd_error_handler (_("%pB: unsupported relocation type %#x"), abfd, r_type);
      bfd_set_error (bfd_error_bad_value);
      return false;
...
link_hash_newfunc(struct bfd_hash_entry *entry,
                  ...
                  const char *string)
{
  struct bfd_hash_entry *result = entry;

  if (result == NULL) {
    result = bfd_hash_allocate(table, sizeof(struct elf32_mb_link_hash_entry));
    if (result == NULL)
      return NULL;
  }

  result = _bfd_elf_link_hash_newfunc(result, table, string);
  if (result == NULL)
    return NULL;

  ((struct elf32_mb_link_hash_entry *) result)->tls_mask = 0;
...
{
  struct elf32_mb_link_hash_table *table;
...
static bool
microblaze_resolve_sda_anchor(struct bfd_link_info *info, const char *name, bfd_vma *out_value)
{
  if (info == NULL || info->hash == NULL || name == NULL || out_value == NULL)
    return false;
  ...
  if (h->u.def.section == NULL || h->u.def.section->output_section == NULL)
    return false;

  *out_value = h->u.def.value
...
microblaze_elf_final_sdp (struct bfd_link_info *info)
{
  ...
  if (microblaze_resolve_sda_anchor(info, RO_SDA_ANCHOR_NAME, &value))
    ro_small_data_pointer = value;

  if (microblaze_resolve_sda_anchor(info, RW_SDA_ANCHOR_NAME, &value))
    rw_small_data_pointer = value;
}
...
static void microblaze_elf_output_dynamic_relocation(bfd *output_bfd,
                                                      asection *sreloc,
                                                      ...
                                                      bfd_vma addend)
{
  ...
  size_t ext_size = sizeof(Elf32_External_Rela);
  size_t index;
  size_t byte_offset;
  ...
  index = (size_t)reloc_index;
  if (sizeof(unsigned long) > sizeof(size_t) && reloc_index != (unsigned long)index)
    return;

  if (index > SIZE_MAX / ext_size)
    return;

  byte_offset = index * ext_size;
  sect_size = sreloc->size;

  if (byte_offset > (size_t)sect_size || ext_size > (size_t)sect_size - byte_offset)
    return;

  dst = sreloc->contents + byte_offset;

  rel.r_info = ELF32_R_INFO(indx, r_type);
  rel.r_offset = offset;
  rel.r_addend = addend;

  bfd_elf32_swap_reloca_out(output_bfd, &rel, dst);
}
...
static inline void mb_write_two_halves(bfd *abfd, bfd_byte *contents, bfd_vma offset, int endian, bfd_vma value)
{
  bfd_put_16(abfd, (value >> 16) & 0xffff, contents + offset + endian);
  bfd_put_16(abfd, value & 0xffff, contents + offset + endian + INST_WORD_SIZE);
}

static inline void mb_write_gotoff_64(bfd *abfd, bfd_byte *contents, bfd_vma offset, int endian, bfd_vma value)
{
  unsigned short lo = value & 0x0000ffff;
  unsigned short hi = (value >> 16) & 0x0000ffff;
  bfd_put_16(abfd, hi, contents + offset + endian);
  bfd_put_16(abfd, lo, contents + offset + INST_WORD_SIZE + endian);
}

static void mb_report_wrong_section(bfd *ibfd, const char *sym_name, int r_type, asection *sec)
{
  _bfd_error_handler(_("%pB: the target (%s) of an %s relocation is in the wrong section (%pA)"),
                     ibfd, sym_name, microblaze_elf_howto_table[(int) r_type]->name, sec);
}
	  ...
	  switch ((int) r_type)
	      ...
	      if (sec)
		{
		  ...
		  if (strcmp (name, ".sdata2") == 0 || strcmp (name, ".sbss2") == 0)
		    ...
		    {
		      mb_report_wrong_section(input_bfd, sym_name, r_type, sec);
		      ret = false;
		      continue;
		    }
		}
	    ...
	    case (int) R_MICROBLAZE_GOTPC_64:
	      {
		bfd_vma tmp = (htab->elf.sgotplt->output_section->vma + htab->elf.sgotplt->output_offset);
		tmp -= (input_section->output_section->vma + input_section->output_offset + offset + INST_WORD_SIZE);
		tmp += addend;
		mb_write_two_halves(input_bfd, contents, offset, endian, tmp);
	      }
	      break;

	    case (int) R_MICROBLAZE_TEXTPCREL_64:
	      {
		bfd_vma tmp = input_section->output_section->vma;
		tmp -= (input_section->output_section->vma + input_section->output_offset + offset + INST_WORD_SIZE);
		tmp += addend;
		mb_write_two_halves(input_bfd, contents, offset, endian, tmp);
	      }
		...
		if (htab->elf.splt != NULL && h != NULL && h->plt.offset != (bfd_vma) -1)
		  {
		    ...
		    mb_write_two_halves(input_bfd, contents, offset, endian, immediate);
		  }
		else
		  {
		    bfd_vma tmp = relocation - (input_section->output_section->vma
						+ input_section->output_offset
						+ offset + INST_WORD_SIZE);
		    mb_write_two_halves(input_bfd, contents, offset, endian, tmp);
		  }
		...
		mb_write_two_halves(input_bfd, contents, offset, endian, relocation);
		unresolved_reloc = false;
		break;
	      }
		...
		mb_write_gotoff_64(input_bfd, contents, offset, endian, immediate);
	      }
	      break;
	    ...
	    case (int) R_MICROBLAZE_TLSDTPREL64:
	      {
		bfd_vma tmp = relocation + addend - dtprel_base(info);
		mb_write_two_halves(input_bfd, contents, offset, endian, tmp);
	      }
	      break;
...
calc_fixup (bfd_vma start, bfd_vma size, asection *sec)
{
  ...
  for (i = 0; i < sdata->relax_count; i++)
    {
      bfd_vma addr = sdata->relax[i].addr;

      if (end <= addr)
        break;

      if (end != start && start > addr)
        continue;
...
{
    const bfd_vma IMM16_MASK = 0x0000FFFFu;
    const bfd_vma UPPER16_MASK = 0xFFFF0000u;

    if (abfd == NULL || bfd_addr == NULL)
        return;

    bfd_vma instr = bfd_get_32(abfd, bfd_addr) & 0xFFFFFFFFu;
    instr = (instr & UPPER16_MASK) | (val & IMM16_MASK);
...
microblaze_bfd_write_imm_value_64 (bfd *abfd, bfd_byte *bfd_addr, bfd_vma val)
{
    ...
    const bfd_vma mask16 = (bfd_vma)0xFFFFu;
    bfd_byte *const lo_ptr = bfd_addr + INST_WORD_SIZE;

    bfd_vma instr_hi = bfd_get_32 (abfd, bfd_addr);
    instr_hi = (instr_hi & ~mask16) | ((val >> 16) & mask16);
    bfd_put_32 (abfd, instr_hi, bfd_addr);

    bfd_vma instr_lo = bfd_get_32 (abfd, lo_ptr);
    instr_lo = (instr_lo & ~mask16) | (val & mask16);
    bfd_put_32 (abfd, instr_lo, lo_ptr);
}

static bool ensure_cached_section_contents(bfd *abfd, asection *sec, bfd_byte **out_contents)
{
  ...
  if (contents == NULL)
  {
    ...
    if (contents == NULL)
      return false;
    if (!bfd_get_section_contents(abfd, sec, contents, (file_ptr) 0, sec->rawsize))
    {
      free(contents);
      return false;
    }
...
static inline bool fits_in_signed_16(bfd_vma v)
{
  return ((v & 0xffff8000) == 0) || ((v & 0xffff8000) == 0xffff8000);
}
			      ...
			      bool *again)
{
  ...
  *again = false;
  ...
  {
    unsigned int rtype = ELF32_R_TYPE (irel->r_info);
    bfd_vma symval;

    if (rtype != (unsigned int) R_MICROBLAZE_64_PCREL
        && rtype != (unsigned int) R_MICROBLAZE_64
        && rtype != (unsigned int) R_MICROBLAZE_TEXTREL_64)
      continue;
    ...
    else if (rtype == (unsigned int) R_MICROBLAZE_TEXTREL_64)
    {
  ...
  if (sdata->relax_count > 0)
  {
    ...
    for (irel = internal_relocs; irel < irelend; irel++)
    {
      ...
      switch ((enum elf_microblaze_reloc_type) ELF32_R_TYPE (irel->r_info))
      {
        ...
        {
          size_t sfix = calc_fixup (irel->r_offset, 0, sec);
          bfd_vma target_address = irel->r_addend + irel->r_offset;
          size_t efix = calc_fixup (target_address, 0, sec);
        ...
        {
          size_t sfix = calc_fixup (irel->r_offset + INST_WORD_SIZE, 0, sec);
    ...
    for (o = abfd->sections; o != NULL; o = o->next)
    {
      ...
      {
        unsigned int rtype = ELF32_R_TYPE (irelscan->r_info);

        if (rtype == (unsigned int) R_MICROBLAZE_32
            || rtype == (unsigned int) R_MICROBLAZE_32_NONE)
        {
          isym = isymbuf + ELF32_R_SYM (irelscan->r_info);

          if (isym->st_shndx == shndx && (ELF32_ST_TYPE (isym->st_info) == STT_SECTION))
          {
            if (ocontents == NULL && !ensure_cached_section_contents (abfd, o, &ocontents))
              goto error_return;

            irelscan->r_addend -= calc_fixup (irelscan->r_addend, 0, sec);
          }
          else if (rtype == (unsigned int) R_MICROBLAZE_32_SYM_OP_SYM)
          {
            isym = isymbuf + ELF32_R_SYM (irelscan->r_info);
        ...
        else if (rtype == (unsigned int) R_MICROBLAZE_32_PCREL_LO
                 || rtype == (unsigned int) R_MICROBLAZE_32_LO
                 || rtype == (unsigned int) R_MICROBLAZE_TEXTREL_32_LO)
        {
          isym = isymbuf + ELF32_R_SYM (irelscan->r_info);
        ...
        if (rtype == (unsigned int) R_MICROBLAZE_64
            || rtype == (unsigned int) R_MICROBLAZE_TEXTREL_64)
        {
          isym = isymbuf + ELF32_R_SYM (irelscan->r_info);
        ...
        else if (rtype == (unsigned int) R_MICROBLAZE_64_PCREL)
        {
          isym = isymbuf + ELF32_R_SYM (irelscan->r_info);
          ...
          if (isym->st_shndx == shndx && (ELF32_ST_TYPE (isym->st_info) == STT_SECTION))
          {
            ...
            instr_hi = bfd_get_32 (abfd, ocontents + irelscan->r_offset);
            instr_lo = bfd_get_32 (abfd, ocontents + irelscan->r_offset + INST_WORD_SIZE);
            immediate = ((instr_hi & 0x0000ffff) << 16) | (instr_lo & 0x0000ffff);
            target_address = immediate;
            offset = calc_fixup (target_address, 0, sec);
            immediate -= offset;
            irelscan->r_addend -= offset;
  ...
  if (h != NULL && rel != NULL)
    {
      ...
      if (rtype == R_MICROBLAZE_GNU_VTINHERIT || rtype == R_MICROBLAZE_GNU_VTENTRY)
        return NULL;
    }
                       ...
                       unsigned int tls_type)
{
  ...
  bfd_size_type count = symtab_hdr->sh_info;
  if (r_symndx >= count)
    return false;
  ...
  if (local_got_refcounts == NULL)
    {
      bfd_size_type elem_sizes = sizeof (*local_got_refcounts) + sizeof (unsigned char);
      bfd_size_type size = count;

      if (count != 0 && elem_sizes != 0 && size > (bfd_size_type) -1 / elem_sizes)
        return false;
  ...
  unsigned char *local_got_tls_masks =
    (unsigned char *) (local_got_refcounts + count);
...
static struct elf_link_hash_entry *resolve_final_hash_entry(struct elf_link_hash_entry *h)
{
...
static bool ensure_got(struct elf32_mb_link_hash_table *htab, struct bfd_link_info *info, bfd *abfd)
{
  if (htab->elf.sgot != NULL)
    return true;
...
static bool handle_got_reloc(struct elf32_mb_link_hash_table *htab,
                             struct bfd_link_info *info,
                             bfd *abfd,
                             struct elf_link_hash_entry *h,
                             ...
                             Elf_Internal_Shdr *symtab_hdr)
{
  ...
  return update_local_sym_info(abfd, symtab_hdr, r_symndx, tls_type);
}

static bool record_dynamic_reloc(struct elf32_mb_link_hash_table *htab,
                                 asection *sec,
                                 bfd *abfd,
                                 unsigned long r_symndx,
                                 struct elf_link_hash_entry *h,
  ...
  if (*psreloc == NULL)
    {
      if (htab->elf.dynobj == NULL)
        htab->elf.dynobj = abfd;
      *psreloc = _bfd_elf_make_dynamic_reloc_section(sec, htab->elf.dynobj, 2, abfd, 1);
      if (*psreloc == NULL)
        return false;
    }
  ...
  for (rel = relocs; rel < rel_end; rel++)
    {
      ...
      bool is_alloc = (sec->flags & SEC_ALLOC) != 0;

      if (r_symndx >= symtab_hdr->sh_info)
        {
          h = sym_hashes[r_symndx - symtab_hdr->sh_info];
          h = resolve_final_hash_entry(h);
        }
      ...
      switch (r_type)
        ...
        case R_MICROBLAZE_TLSGD:
          tls_type = (TLS_TLS | TLS_GD);
          sec->has_tls_reloc = 1;
          if (!handle_got_reloc(htab, info, abfd, h, tls_type, r_symndx, symtab_hdr))
            return false;
          break;
            ...
            if ((is_pic && is_alloc
                ...
                || (!is_pic && is_alloc
                    ...
                    && (h->root.type == bfd_link_hash_defweak
                        || !h->def_regular)))
              {
                if (!record_dynamic_reloc(htab, sec, abfd, r_symndx, h, r_type, &sreloc))
                  return false;
              }
          }
          break;
                                    ...
                                    struct elf_link_hash_entry *ind)
{
    ...
    const struct elf32_mb_link_hash_entry *eind = (const struct elf32_mb_link_hash_entry *) ind;
                                      ...
                                      struct elf_link_hash_entry *h)
{
  ...
  if ((h->root.u.def.section->flags & SEC_ALLOC) != 0)
    {
      bfd_size_type add = (bfd_size_type) sizeof (Elf32_External_Rela);
      if (srel->size > (bfd_size_type) -1 - add)
        return false;
      srel->size += add;
      h->needs_copy = 1;
    }
  ...
  {
    bfd_size_type align = (bfd_size_type) (1u << power_of_two);
    bfd_size_type new_size = BFD_ALIGN (s->size, align);
    if (new_size < s->size)
      return false;
    s->size = new_size;
  }
  ...
  if (s->size > (bfd_size_type) -1 - h->size)
    return false;
  s->size += h->size;
				   ...
				   struct bfd_link_info *info)
{
  ...
  for (ibfd = info->input_bfds; ibfd != NULL; ibfd = ibfd->link.next)
      ...
      for (s = ibfd->sections; s != NULL; s = s->next)
	{
	  ...
	  p = (struct elf_dyn_relocs *) elf_section_data (s)->local_dynrel;
	  for (; p != NULL; p = p->next)
	    {
	      asection *psec;
		...
		continue;
	      ...
	      if (!bfd_is_abs_section (psec)
		  && bfd_is_abs_section (psec->output_section))
		continue;
	      ...
	      if (p->count != 0)
		{
		  ...
		  srel = elf_section_data (psec)->sreloc;
		  if (srel == NULL)
		    return false;

		  srel->size += (bfd_size_type) p->count * sizeof (Elf32_External_Rela);
		  if (psec->output_section != NULL
		      && (psec->output_section->flags & SEC_READONLY) != 0)
  ...
  if (htab->tlsld_got.refcount > 0)
	...
	return false;
      ...
      htab->tlsld_got.offset = sgot->size;
      sgot->size += 8;
      if (is_pic)
	{
	  if (htab->elf.srelgot == NULL)
                                     ...
                                     Elf_Internal_Sym *sym)
{
  ...
  if (h->plt.offset != (bfd_vma) -1)
    {
      ...
      bfd_vma got_offset;
      bfd_vma got_addr;
      bfd_vma sgotplt_base;
      bfd_byte *plt_loc;

      BFD_ASSERT (h->dynindx != -1);
      BFD_ASSERT (splt != NULL && srela != NULL && sgotplt != NULL);
      if (!splt || !srela || !sgotplt || !splt->contents || !srela->contents || !sgotplt->output_section)
        return false;
      ...
      sgotplt_base = sgotplt->output_section->vma + sgotplt->output_offset;
      if (!is_pic)
        got_addr += sgotplt_base;

      plt_loc = splt->contents + h->plt.offset;

      bfd_put_32(output_bfd, PLT_ENTRY_WORD_0 + ((got_addr >> 16) & 0xffff), plt_loc);
      if (is_pic)
        bfd_put_32(output_bfd, PLT_ENTRY_WORD_1 + (got_addr & 0xffff), plt_loc + 4);
      else
        bfd_put_32(output_bfd, PLT_ENTRY_WORD_1_NOPIC + (got_addr & 0xffff), plt_loc + 4);
      bfd_put_32(output_bfd, (bfd_vma) PLT_ENTRY_WORD_2, plt_loc + 8);
      bfd_put_32(output_bfd, (bfd_vma) PLT_ENTRY_WORD_3, plt_loc + 12);

      rela.r_offset = sgotplt_base + got_offset;
  ...
  if ((h->got.offset != (bfd_vma) -1)
           ...
           || IS_TLS_LD(eh->tls_mask) || IS_TLS_GD(eh->tls_mask)))
    {
      ...
      bfd_vma got_off_aligned;
      bfd_vma sgot_base;
      bfd_vma offset;

      BFD_ASSERT(sgot != NULL && srela != NULL);
      if (!sgot || !srela || !sgot->contents || !sgot->output_section)
        return false;

      got_off_aligned = (h->got.offset & ~(bfd_vma) 1);
      sgot_base = sgot->output_section->vma + sgot->output_offset;
      offset = sgot_base + got_off_aligned;

      if (is_pic && ((info->symbolic && h->def_regular) || h->dynindx == -1))
        {
      ...
      bfd_put_32(output_bfd, (bfd_vma) 0, sgot->contents + got_off_aligned);
    }
  ...
  if (h->needs_copy)
    {
      ...
      Elf_Internal_Rela rela;
      bfd_byte *loc;
      asection *defsec = h->root.u.def.section;

      BFD_ASSERT (h->dynindx != -1);
      if (!defsec || !defsec->output_section)
        return false;

      rela.r_offset = (h->root.u.def.value
                       + defsec->output_section->vma
                       + defsec->output_offset);
      rela.r_info = ELF32_R_INFO(h->dynindx, R_MICROBLAZE_COPY);
      rela.r_addend = 0;

      s = (defsec == htab->elf.sdynrelro) ? htab->elf.sreldynrelro : htab->elf.srelbss;
      if (!s || !s->contents)
        return false;
...
{
  struct elf32_mb_link_hash_table *htab = elf32_mb_hash_table(info);
  const unsigned int entsize_word = 4;
  bfd *dynobj;
  asection *sdyn;
  asection *sgot;
  ...
  dynobj = htab->elf.dynobj;
  sdyn = dynobj ? bfd_get_linker_section(dynobj, ".dynamic") : NULL;

  if (htab->elf.dynamic_sections_created)
    {
      asection *splt = htab->elf.splt;

      if (sdyn && sdyn->contents && sdyn->size >= sizeof(Elf32_External_Dyn))
	{
	  Elf32_External_Dyn *table = (Elf32_External_Dyn *) sdyn->contents;
	  size_t count = sdyn->size / sizeof(Elf32_External_Dyn);
	  size_t i;
	  ...
	  for (i = 0; i < count; i++)
	    {
	      ...
	      bfd_elf32_swap_dyn_in(dynobj, &table[i], &dyn);
	      ...
	      else
		{
	      ...
	      bfd_elf32_swap_dyn_out(output_bfd, &dyn, &table[i]);
	    }
	}

      if (splt && splt->contents && splt->size > 0)
	{
	  size_t clear_size = splt->size < PLT_ENTRY_SIZE ? splt->size : PLT_ENTRY_SIZE;
	  memset(splt->contents, 0, clear_size);

	  if (splt->size >= entsize_word)
	    bfd_put_32(output_bfd, (bfd_vma) 0x80000000, splt->contents + splt->size - entsize_word);

	  if (splt->output_section != bfd_abs_section_ptr && splt->output_section)
	    elf_section_data(splt->output_section)->this_hdr.sh_entsize = entsize_word;
	}
    }

  sgot = htab->elf.sgotplt;
  if (sgot && sgot->size > 0 && sgot->contents)
    {
	...
	elf_section_data(sgot->output_section)->this_hdr.sh_entsize = entsize_word;
    }

  if (htab->elf.sgot && htab->elf.sgot->size > 0 && htab->elf.sgot->output_section)
    elf_section_data(htab->elf.sgot->output_section)->this_hdr.sh_entsize = entsize_word;
...
microblaze_elf_add_symbol_hook (bfd *abfd,
                                ...
                                bfd_vma *valp)
{
  if (abfd == NULL || info == NULL || sym == NULL || secp == NULL || valp == NULL)
    return false;
  ...
  asection *sec = bfd_make_section_old_way (abfd, ".sbss");
  if (sec == NULL)
    return false;
